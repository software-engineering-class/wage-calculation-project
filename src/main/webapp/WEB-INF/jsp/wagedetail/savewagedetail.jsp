        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                <div class="radio-box">
                    ...
                    <label for="types-1">基本工资</label>
                </div>
                <div class="radio-box">
                    <input type="radio" id="types-2" name="types" value="1">
                    <label for="types-2">奖金</label>
                </div>
                <div class="radio-box">
                    <input type="radio" id="types-3" name="types" value="2">
                    <label for="types-3">津贴</label>
                </div>
                <div class="radio-box">
                    <input type="radio" id="types-4" name="types" value="3">
                    <label for="types-4">福利</label>
                </div>
            </div>
        </div>
