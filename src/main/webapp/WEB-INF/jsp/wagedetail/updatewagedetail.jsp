...
<div class="page-container">
    ...
    <form action="${pageContext.request.contextPath}/wagedetail/updatewagedetail" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data" name="tijiao">

        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>职工名：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${username}" placeholder="" name="username">
            </div>
        </div>

        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">项目名：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <span class="select-box">
                <select  class="select" name="projectid" size="1">
                    <c:forEach items="${sort}" var="r" >
                        <option value="${r.projectid}" selected="selected" >${r.projectname}</option>
                    </c:forEach>
                </select>
				</span>
            </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="projectamount"  placeholder="" value="" class="input-text">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="dates"  placeholder="" value="" class="input-text">
                </div>
        </div>
