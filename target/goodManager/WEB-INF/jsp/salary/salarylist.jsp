...
<div class="page-container">
    <div class="text-c">
        <form action="${pageContext.request.contextPath}/salary/selectall" method="post">
            <div class="text-c">
                ...
                <button type="button" class="btn btn-success"  name="" onClick="location.href='savesalary'"><i class="Hui-iconfont">&#xe600;</i> 添加</button>
                <button type="submit" class="btn btn-success radius" name=""><i class="Hui-iconfont" >&#xe665;</i> 搜工资</button>
            </div>
        </form>
    ...
    <div class="text-c">
      <form action="${pageContext.request.contextPath}/salary/leadsalary" method="post">
          <div class="text-c">
