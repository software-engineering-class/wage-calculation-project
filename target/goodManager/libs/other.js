							...
							$.ajax({
							   ...
							   success:function(msg){
									...
									$(".del_close",Wparent).click(function(){
										Tipclose();
										$("a[name='cont_box']",Wparent).prop("href",$("a[name='cont_box']",Wparent).prop("href"));
									});
							   },
...
//		}
	...
	//姓名
	jQuery.validator.addMethod("customername", function (value, element) {
	...
	//预售卡卡号
	jQuery.validator.addMethod("customerid", function (value, element) {
		var name = /^[0-9]{5,40}$/;
		return this.optional(element) || (name.test(value));
	}, "请输入正确的卡号");
	//name相同时用id验证
